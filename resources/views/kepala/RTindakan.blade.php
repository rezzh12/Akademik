...
@section('content')
    <div class="container-fluid">
        <div class="card card-default">
            ...
            <li class="nav-item">
                <a class="nav-link " aria-current="page" href="{{ route('kepala.tindakan') }}">Data Tindakan Kelas</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('kepala.RTindakan') }}">Data Riwayat Tindakan</a>
            </li>
            </ul>
            <hr />
