...
@section('content')
    <div class="container-fluid">
        <div class="card card-default">
            ...
            <li class="nav-item">
                <a class="nav-link " aria-current="page" href="{{ route('walikelas.tindakan') }}">Data Tindakan Kelas</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('walikelas.RTindakan') }}">Data Riwayat Tindakan</a>
            </li>
            </ul>
            <hr />
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('walikelas.RTindakan.submit') }}" enctype="multipart/form-data">
                        @csrf
     ...
     <div class="modal fade" id="editMasukModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('walikelas.RTindakan.update') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="form-group">
