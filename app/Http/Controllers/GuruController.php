...
class GuruController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('guru.Dashboard', compact('user','siswa','guru','kelas','pengguna','riwayat','ekskul'));
    }
    public function jadwal(){
        ...
        return view('guru.jadwalPelajaran', compact('user','jadwal','ekskul'));
    }
    ...
    public function pengampu(){
        ...
        return view('guru.pengampu', compact('user','pengampu','akademik','ekskul'));
    }
    public function penilaian($id){
        ...
        return view('guru.penilaian', compact('user','penilaian','pengampu','ekskul'));
    }
    ...
    public function riwayat_penilaian($id){
        ...
        return view('guru.riwayat', compact('user','riwayat','pengampu','ekskul'));
    }
    ...
    public function hasil($id){
        ...
        return view('guru.nilai', compact('user','nilai','pengampu1','ekskul'));
    }
    ...
    public function RTindakan()
    {
        ...
        return view('guru.RTindakan', compact( 'user','RTindakan','ekskul'));
    }
